...
namespace SistemaOro.Data.Entities
{
    ...
    public partial class DataContext : DbContext
    {
        ...
        private void AdelantoMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Adelanto>().HasKey(@"Idsalida", @"Codcliente", @"Numcompra");
        }
        ...
        {
            modelBuilder.Entity<Detacaja>().HasOne(x => x.Detacaja_Idcaja_Fecha).WithOne(op => op.Detacaja_Idcaja_Fecha1).HasForeignKey(typeof(Detacaja), @"Idcaja", @"Fecha").IsRequired(true);
        }
