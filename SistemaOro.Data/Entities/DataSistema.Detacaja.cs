...
namespace SistemaOro.Data.Entities
{
    public partial class Detacaja : INotifyPropertyChanging, INotifyPropertyChanged {
        ...
        {
            this._Tipocambio = 1m;
            this._EfectivoExt = 0m;
            this._ChequeExt = 0m;
            this._TransferenciaExt = 0m;
            OnCreated();
        }
        ...
        public int? Idmoeda
        {
            get
            {
                return this._Idmoeda;
            }
            set
            {
                if (this._Idmoeda != value)
                {
                    this.SendPropertyChanging("Idmoeda");
                    this._Idmoeda = value;
                    this.SendPropertyChanged("Idmoeda");
                }
            }
        }
