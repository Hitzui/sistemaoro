...
public interface IRepositoryAdelantos
{
    ...
    bool AplicarAdelantoEfectivo(List<Adelanto> listaAdelantos, decimal monto, string codCliente = "");
    ...
    List<Adelanto> ListarAdelantosPorFecha(DateTime desde, DateTime hasta, string codCliente);
    /// <summary>
    ...
    List<ComprasAdelanto> ListarAdelantosComrpas(string idAdelanto);
    /// <summary>
    /// Recupera la lista de adelantos aplicados por compras segun el cliente indicado
    /// </summary>
    /// <param name="codCliente">Codigo del cliente</param>
    /// <returns>Lista de compras-adelantos</returns>
    List<ComprasAdelanto> ListarAdelantosComrpasCliente(string codCliente);
}